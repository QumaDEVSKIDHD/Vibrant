    ...
    override fun onEnable() {
        GameResourceManager.lockResource(
                ResourceLock(
                        ...
                        RotationResource,
                        {
                            mc.thePlayer!!.getItemInUseCount() != 0 && mc.thePlayer!!.getHeldItem() != null
                                    && mc.thePlayer!!.getHeldItem()!!.getItem() is VibrantItemBow
                        },
                        { ResourceRequestPriority.combat },
                        {
                            ...
                            if (entity == null) {
                                return@ResourceLock RotationResource.RotationState() // don't care
                            } else {
                                ...
                                val playerHeadPosition =
                                        factory.newVec3(mc.thePlayer!!.posX - Math.cos(Math.toRadians(yaw.toDouble())) * 0.16f,
                                ...
                                val motionX =
                                        entity!!.posX - (entity!!.chasingPosX + (entity!!.posX - entity!!.chasingPosX) * mc.timer.renderPartialTicks)
                                val motionZ =
                                        entity!!.posZ - (entity!!.chasingPosZ + (entity!!.posZ - entity!!.chasingPosZ) * mc.timer.renderPartialTicks)
                                ...
                                if (prediction != null) {
                                    ...
                                    return@ResourceLock RotationResource.RotationState(predictedYaw, predictedPitch)
                                } else {
                                    return@ResourceLock RotationResource.RotationState() // don't care
                                }
                            }
